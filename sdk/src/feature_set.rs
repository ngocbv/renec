...
pub mod stake_program_v3 {
    solana_sdk::declare_id!("4mrjvnK4zvmmKQXvBExXXB3DWSuXJxYK7BJ3q6bGhWmi");
}
...
pub mod stake_program_v4 {
    solana_sdk::declare_id!("4Je61XLdVZpL691Yvs9naXwtdcZj9645C79bvxAXUiqf");
}
...
pub mod deterministic_shred_seed_enabled {
    solana_sdk::declare_id!("4AsyPYj94FCmgpmeTebT7TsMiPjsFhCXD7Sm2wa1JUvF");
}
...
pub mod turbine_peers_shuffle {
    solana_sdk::declare_id!("A6dqR545aRwTpvd3yyFncdovYzcFDHuZfukStcoC9HU3");
}
