...
const VERIFIED_MINERS_AMOUNT: f64 = 35_013_489.0;
const UNVERIFIED_MINERS_AMOUNT: f64 = 10_074_370.0;
...
mod tests {
    ...
    fn test_add_genesis_accounts() {
        ...
        assert_eq!(MINERS_AND_REMITANO_INFOS[0].lamports, 35_580_207 * LAMPORTS_PER_SOL);
        ...
        assert_eq!(DAPPS_STAKER_INFOS[0].lamports, 6_657_499 * LAMPORTS_PER_SOL);
        ...
        assert_eq!(lamports, 72_232_484 * LAMPORTS_PER_SOL);
    }
}
