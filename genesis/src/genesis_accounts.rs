...
// 20% for first year, then monthly for 4 years
const UNLOCKS_20_AT_FIRST_YEAR: UnlockInfo = UnlockInfo {
    cliff_fraction: 0.2,
    cliff_years: 0.0,
    unlocks: 10,
    unlock_years: 0.001,
...
pub const MINERS_STAKER_INFOS: &[StakerInfo] = &[
    StakerInfo {
        ...
        lamports: 40_000_000 * LAMPORTS_PER_SOL,
