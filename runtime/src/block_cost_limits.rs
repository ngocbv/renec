...
lazy_static! {
    ...
    pub static ref BUILT_IN_INSTRUCTION_COSTS: HashMap<Pubkey, u64> = [
        ...
        (renec_sdk::stake::config::id(), COMPUTE_UNIT_TO_US_RATIO * 2),
        (renec_sdk::stake::program::id(), COMPUTE_UNIT_TO_US_RATIO * 25),
        (renec_config_program::id(), COMPUTE_UNIT_TO_US_RATIO * 15),
        (renec_vote_program::id(), COMPUTE_UNIT_TO_US_RATIO * 70),
