...
The `renec-crate-features` offers a workaround to this "feature thrashing"
...
crates in the Solana source tree should depend on `renec-crate-features`.
...
dependency of `renec-crate-features` with the union of all observed enabled
