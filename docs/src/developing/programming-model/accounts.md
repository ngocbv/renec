...
This value is calculated to target 0.01 RENEC per mebibyte-day (exactly matching
to 3.56 RENEC per mebibyte-year):

```text
Rent fee: 19.055441478439427 = 10_000_000 (0.01 RENEC) * 365(approx. day in a year) / (1024 * 1024)(1 MiB) / (365.25/2)(epochs in 1 year)
```
