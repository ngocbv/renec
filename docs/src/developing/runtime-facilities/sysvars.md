...
[`renec-program`
crate](https://docs.rs/renec-program/VERSION_FOR_DOCS_RS/renec_program/sysvar/index.html),
and outlined below.
...
- Layout: [Clock](https://docs.rs/renec-program/VERSION_FOR_DOCS_RS/renec_program/clock/struct.Clock.html)
- Fields:
...
- Layout:
  [EpochSchedule](https://docs.rs/renec-program/VERSION_FOR_DOCS_RS/renec_program/epoch_schedule/struct.EpochSchedule.html)
...
- Layout:
  [Fees](https://docs.rs/renec-program/VERSION_FOR_DOCS_RS/renec_program/sysvar/fees/struct.Fees.html)
...
- Layout:
  [Instructions](https://docs.rs/renec-program/VERSION_FOR_DOCS_RS/renec_program/sysvar/instructions/struct.Instructions.html)
...
- Layout:
  [RecentBlockhashes](https://docs.rs/renec-program/VERSION_FOR_DOCS_RS/renec_program/sysvar/recent_blockhashes/struct.RecentBlockhashes.html)
...
- Layout:
  [Rent](https://docs.rs/renec-program/VERSION_FOR_DOCS_RS/renec_program/rent/struct.Rent.html)
...
- Layout:
  [SlotHashes](https://docs.rs/renec-program/VERSION_FOR_DOCS_RS/renec_program/slot_hashes/struct.SlotHashes.html)
...
- Layout:
  [SlotHistory](https://docs.rs/renec-program/VERSION_FOR_DOCS_RS/renec_program/slot_history/struct.SlotHistory.html)
...
- Layout:
  [StakeHistory](https://docs.rs/renec-program/VERSION_FOR_DOCS_RS/renec_program/stake_history/struct.StakeHistory.html)
